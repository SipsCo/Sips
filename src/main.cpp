...
int nCoinbaseMaturity = 44; // 45 in total
...
const string strMessageMagic = "Sips Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  // 25% yearly interest 
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 100; // 2,500% yearly interest
    }
    else if (pindexBest->nHeight < 25000)
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 10; // 250% yearly interest
    }
