...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Sips
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Sips
    // Mac: ~/Library/Application Support/Sips
    // Unix: ~/.Sips
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sips";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sips.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sipsd.pid"));
